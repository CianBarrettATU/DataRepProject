...
const GameItem = (props)=>{
    ...
    return(
        <div>
            <Card style={{margin: '20px', backgroundColor: 'grey', border: '2px solid black', display: 'flex', flexDirection: 'column', alignItems: 'left'}}>
              ...
              <div style={{display: 'flex', justifyContent: 'left', gap: '10px', padding: '10px'}}>
                ...
                <Link className="btn btn-success d-inline-block" to={"/review/"+ props.mygame._id} style={{border: '2px solid black'}}>Review</Link>
              </div>
